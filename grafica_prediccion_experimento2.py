...
q_5_x = np.loadtxt(F"cuantil_5_x_exp2_{k}.txt")
q_25_x = np.loadtxt(F"cuantil_25_x_exp2_{k}.txt")
q_75_x = np.loadtxt(F"cuantil_75_x_exp2_{k}.txt")
q_95_x = np.loadtxt(F"cuantil_95_x_exp2_{k}.txt")
mediana_x =np.loadtxt(F"mediana_x_exp2_{k}.txt")
#Y
q_5_y = np.loadtxt(F"cuantil_5_y_exp2_{k}.txt")
q_25_y = np.loadtxt(F"cuantil_25_y_exp2_{k}.txt")
q_75_y = np.loadtxt(F"cuantil_75_y_exp2_{k}.txt")
q_95_y = np.loadtxt(F"cuantil_95_y_exp2_{k}.txt")
mediana_y = np.loadtxt(F"mediana_y_exp2_{k}.txt")
#Z
q_5_z =np.loadtxt(F"cuantil_5_z_exp2_{k}.txt")
q_25_z =np.loadtxt(F"cuantil_25_z_exp2_{k}.txt")
q_75_z =np.loadtxt(F"cuantil_75_z_exp2_{k}.txt")
q_95_z =np.loadtxt(F"cuantil_95_z_exp2_{k}.txt")
mediana_z =np.loadtxt(F"mediana_z_exp2_{k}.txt")

#MAP
sol_map = np.loadtxt(F"sol_map_exp2_{k}.txt")
...
plt_X.savefig(F"grafica_prediccion_mediana_x_exp2_{k}.png")
...
plt_Y.savefig(F"grafica_prediccion_mediana_y_exp2_{k}.png")
...
plt_Z.savefig(F"grafica_prediccion_mediana_z_exp2_{k}.png")
