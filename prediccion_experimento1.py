...
time = np.loadtxt("datot_exp1.txt")
...
map = np.loadtxt(F"map_exp1_{k}.txt")
solmap = solution_model(map)
np.savetxt(F"sol_map_exp1_{k}.txt",solmap)
...
np.savetxt(F"cuantil_5_x_exp1_{k}.txt",q_5_x)
np.savetxt(F"cuantil_25_x_exp1_{k}.txt",q_25_x)
np.savetxt(F"cuantil_75_x_exp1_{k}.txt",q_75_x)
np.savetxt(F"cuantil_95_x_exp1_{k}.txt",q_95_x)
np.savetxt(F"mediana_x_exp1_{k}.txt",mediana_x)
#Y
...
np.savetxt(F"cuantil_5_y_exp1_{k}.txt",q_5_y)
np.savetxt(F"cuantil_25_y_exp1_{k}.txt",q_25_y)
np.savetxt(F"cuantil_75_y_exp1_{k}.txt",q_75_y)
np.savetxt(F"cuantil_95_y_exp1_{k}.txt",q_95_y)
np.savetxt(F"mediana_y_exp1_{k}.txt",mediana_y)
#Z
...
np.savetxt(F"cuantil_5_z_exp1_{k}.txt",q_5_z)
np.savetxt(F"cuantil_25_z_exp1_{k}.txt",q_25_z)
np.savetxt(F"cuantil_75_z_exp1_{k}.txt",q_75_z)
np.savetxt(F"cuantil_95_z_exp1_{k}.txt",q_95_z)
np.savetxt(F"mediana_z_exp1_{k}.txt",mediana_z)
...
p=k+1
np.savetxt(F"info_prior_x_exp1_{p}.txt",prior_x)
np.savetxt(F"info_prior_y_exp1_{p}.txt",prior_y)
np.savetxt(F"info_prior_z_exp1_{p}.txt",prior_z)
