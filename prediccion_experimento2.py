...
time = np.loadtxt("datot_exp2.txt")
datax = np.loadtxt("datox_exp2.txt")
datay = np.loadtxt("datoy_exp2.txt")
dataz = np.loadtxt("datoz_exp2.txt")
...
def solution_model(c):
    ...
    def jacobian_model(t,L):
        ...
        #t = data time
    return solve_ivp(model,t_span=(time[0],time[-1]),y0=[c[0],c[1],c[2]],dense_output=True,jac=jacobian_model,method="LSODA").sol(btime)    


#SOLUTION FOR THE MAP
print("SOLVING FOR MAP")
map = np.loadtxt(F"map_exp2_{k}.txt")
solmap = solution_model(map)
np.savetxt(F"sol_map_exp2_{k}.txt",solmap)
...
np.savetxt(F"cuantil_5_x_exp2_{k}.txt",q_5_x)
np.savetxt(F"cuantil_25_x_exp2_{k}.txt",q_25_x)
np.savetxt(F"cuantil_75_x_exp2_{k}.txt",q_75_x)
np.savetxt(F"cuantil_95_x_exp2_{k}.txt",q_95_x)
np.savetxt(F"mediana_x_exp2_{k}.txt",mediana_x)
#Y
...
np.savetxt(F"cuantil_5_y_exp2_{k}.txt",q_5_y)
np.savetxt(F"cuantil_25_y_exp2_{k}.txt",q_25_y)
np.savetxt(F"cuantil_75_y_exp2_{k}.txt",q_75_y)
np.savetxt(F"cuantil_95_y_exp2_{k}.txt",q_95_y)
np.savetxt(F"mediana_y_exp2_{k}.txt",mediana_y)
#Z
...
np.savetxt(F"cuantil_5_z_exp2_{k}.txt",q_5_z)
np.savetxt(F"cuantil_25_z_exp2_{k}.txt",q_25_z)
np.savetxt(F"cuantil_75_z_exp2_{k}.txt",q_75_z)
np.savetxt(F"cuantil_95_z_exp2_{k}.txt",q_95_z)
np.savetxt(F"mediana_z_exp2_{k}.txt",mediana_z)
...
p=k+1
np.savetxt(F"info_prior_x_exp2_{p}.txt",prior_x)
np.savetxt(F"info_prior_y_exp2_{p}.txt",prior_y)
np.savetxt(F"info_prior_z_exp2_{p}.txt",prior_z)
